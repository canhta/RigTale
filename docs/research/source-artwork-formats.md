...
| PSD defines 28 blend keys, publishes no formulas, and no general 2D library implements the extra twelve (§2.4) | `PR-R002`, `PR-R003`, `PR-R005` | Add a required **supported blend-mode profile** with explicit failure on out-of-profile modes, mirroring `PR-C003` | `applied` |
