...
3. Design an original production brief and cast sufficient to exercise the required archetypes. **Cast done — `fixtures/`, 141 part files holding 84 unique images, covering biped ×3, quadruped, vehicle, prop and environment, with joints, a rig tree, and deformation meshes. Brief outstanding.**
